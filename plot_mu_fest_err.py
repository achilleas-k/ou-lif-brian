...
clf()
plot(fest_err, mu_peaks_est_err)
xlabel(r'$ \varepsilon_f $', size=15)
ylabel(r'$ \varepsilon_{\mu_p} $', size=15)
xticks(linspace(-0.1, 0.1, 5), size=15)
yticks(size=15)
axis(xmin=-0.1, xmax=0.1, ymin=0)
grid()
savefig('figures/mu_err_vs_freq_err.png')
savefig('figures/mu_err_vs_freq_err.pdf')
print "Figure saved!"
